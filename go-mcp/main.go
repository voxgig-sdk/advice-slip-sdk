// Command AdviceSlip-mcp is an MCP server exposing the AdviceSlip
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AdviceSlip_list  — list records of an entity
//	AdviceSlip_load  — load a single record of an entity
//
