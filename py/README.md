# AdviceSlip Python SDK



The Python SDK for the AdviceSlip API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Advice()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/advice-slip-sdk/releases)) or
...
```
py/
├── adviceslip_sdk.py         -- Main SDK module
