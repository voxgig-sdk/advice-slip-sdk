...
class AdviceSlipContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, AdviceSlipSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AdviceSlipResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AdviceSlipResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AdviceSlipError(code, msg, self)
