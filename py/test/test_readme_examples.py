# AdviceSlip SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AdviceSlipSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AdviceSlipSDK(...) and AdviceSlipSDK.test(...) become
#      AdviceSlipSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "adviceslip_sdk"
_SDK_CLASS = "AdviceSlipSDK"
