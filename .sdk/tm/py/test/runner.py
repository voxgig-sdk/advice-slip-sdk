...
class AdviceSlipTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AdviceSlipTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AdviceSlipTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AdviceSlipTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
