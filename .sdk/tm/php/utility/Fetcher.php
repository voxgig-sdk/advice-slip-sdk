...
// AdviceSlip SDK utility: fetcher

class AdviceSlipFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AdviceSlipSDK/1.0)';
    ...
    public static function call(AdviceSlipContext $ctx, string $fullurl, array $fetchdef): array
    {
