...
{
    private static function utility(): AdviceSlipUtility
    {
        return new AdviceSlipUtility();
    }
    ...
    private static function ctx(array $over = []): AdviceSlipContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AdviceSlipContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AdviceSlipOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AdviceSlipError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AdviceSlipOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AdviceSlipMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AdviceSlipOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AdviceSlipMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AdviceSlipOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AdviceSlipMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AdviceSlipSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AdviceSlipMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AdviceSlipResponse([]),
            'result' => new AdviceSlipResult([]),
        ]);
        [, $err] = AdviceSlipMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AdviceSlipSpec([]),
            'response' => null,
            'result' => new AdviceSlipResult([]),
        ]);
        [, $err] = AdviceSlipMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AdviceSlipSpec(['step' => 's']),
            'response' => new AdviceSlipResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AdviceSlipResult([]),
        ]);
        [, $err] = AdviceSlipMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AdviceSlipSpec(['step' => 's']),
            'response' => new AdviceSlipResponse(self::resp(200, ['v' => 1])),
            'result' => new AdviceSlipResult([]),
        ]);
        [, $err] = AdviceSlipMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AdviceSlipSpec(['step' => 's']),
            'response' => new AdviceSlipResponse(self::resp(200, ['v' => 2])),
            'result' => new AdviceSlipResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AdviceSlipMakeResponse::call($ctx);
    ...
    {
        $preset = new AdviceSlipResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AdviceSlipSpec([]),
            'response' => new AdviceSlipResponse([]),
            'result' => new AdviceSlipResult([]),
        ...
        [$got, $err] = AdviceSlipMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AdviceSlipResult([])]);
        [, $err] = AdviceSlipMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AdviceSlipSpec([]), 'result' => null]);
        [, $err] = AdviceSlipMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AdviceSlipSpec(['step' => 's']),
            'result' => new AdviceSlipResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AdviceSlipOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AdviceSlipMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AdviceSlipSpec(['step' => 's']),
            'result' => new AdviceSlipResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AdviceSlipOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AdviceSlipMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AdviceSlipResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AdviceSlipSpec([]),
            'result' => new AdviceSlipResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AdviceSlipMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AdviceSlipMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AdviceSlipError('boom', 'boom');
        $utility->fetcher = function (AdviceSlipContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AdviceSlipSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AdviceSlipMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AdviceSlipContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AdviceSlipMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AdviceSlipResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AdviceSlipMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AdviceSlipContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AdviceSlipSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AdviceSlipMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AdviceSlipResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AdviceSlipSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AdviceSlipMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AdviceSlipMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AdviceSlipMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AdviceSlipResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AdviceSlipDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AdviceSlipResult(['ok' => false])]);
        $this->expectException(AdviceSlipError::class);
        AdviceSlipDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AdviceSlipResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AdviceSlipMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AdviceSlipMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AdviceSlipBaseFeature();
        $b = new AdviceSlipBaseFeature();
        AdviceSlipFeatureAdd::call($ctx, $a);
        AdviceSlipFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AdviceSlipBaseFeature
    {
        $f = new AdviceSlipBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AdviceSlipFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AdviceSlipContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AdviceSlipSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AdviceSlipPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AdviceSlipPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AdviceSlipResponse(['headers' => null]),
            'result' => new AdviceSlipResult([]),
        ]);
        AdviceSlipResultHeaders::call($ctx);
