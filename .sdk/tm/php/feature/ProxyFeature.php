...
class AdviceSlipProxyFeature extends AdviceSlipBaseFeature
{
    ...
    public function init(AdviceSlipContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AdviceSlipContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
