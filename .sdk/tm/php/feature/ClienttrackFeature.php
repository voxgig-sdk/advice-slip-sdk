...
// AdviceSlip SDK clienttrack feature
...
class AdviceSlipClienttrackFeature extends AdviceSlipBaseFeature
{
    ...
    public function PostConstruct(AdviceSlipContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AdviceSlip-SDK';
