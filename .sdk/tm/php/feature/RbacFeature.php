...
class AdviceSlipRbacFeature extends AdviceSlipBaseFeature
{
    ...
    private function _required(AdviceSlipContext $ctx): ?string
    {
    ...
    private function _reject(AdviceSlipContext $ctx, string $required): void
    {
    ...
    private function _track(AdviceSlipContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
