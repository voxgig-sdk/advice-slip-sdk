...
// AdviceSlip SDK idempotency feature
...
class AdviceSlipIdempotencyFeature extends AdviceSlipBaseFeature
{
    ...
    private function _mutating(AdviceSlipContext $ctx): bool
    {
