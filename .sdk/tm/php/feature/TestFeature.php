...
// AdviceSlip SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AdviceSlipTestFeature extends AdviceSlipBaseFeature
{
    ...
    public function init(AdviceSlipContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AdviceSlipContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AdviceSlipParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AdviceSlipContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AdviceSlipContext $ctx, $op, $args): array
    {
