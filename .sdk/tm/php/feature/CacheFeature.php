...
class AdviceSlipCacheFeature extends AdviceSlipBaseFeature
{
    ...
    private function _through(AdviceSlipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
