...
func registerSDKWords(r *eng.Registry, client *sdk.AdviceSlipSDK) {
...
func runOp(client *sdk.AdviceSlipSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
