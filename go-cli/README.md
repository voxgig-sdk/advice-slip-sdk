...
AQL-driven CLI and REPL for the AdviceSlip SDK. Positional arguments are
...
./advice-slip-cli list advice
./advice-slip-cli load 1 advice
./advice-slip-cli load '{id:1}' advice
