...
Learn more about Advice Slip API at [adviceslip.com](https://adviceslip.com).
...
This SDK exposes the API as a small set of **semantic entities** — Advice and Search — that you
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/advice-slip` | publish pending — [install from git tag](https://github.com/voxgig-sdk/advice-slip-sdk/releases) |
| Python | `voxgig-sdk-advice-slip` | publish pending — [install from git tag](https://github.com/voxgig-sdk/advice-slip-sdk/releases) |
| PHP | `voxgig-sdk/advice-slip` | publish pending — [install from git tag](https://github.com/voxgig-sdk/advice-slip-sdk/releases) |
| Golang | `github.com/voxgig-sdk/advice-slip-sdk/go` | `go get github.com/voxgig-sdk/advice-slip-sdk/go@latest` |
| Ruby | `voxgig-sdk-advice-slip` | publish pending — [install from git tag](https://github.com/voxgig-sdk/advice-slip-sdk/releases) |
| Lua | `voxgig-sdk-advice-slip` | publish pending — [install from git tag](https://github.com/voxgig-sdk/advice-slip-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/advice-slip-sdk/go-cli` | `go install github.com/voxgig-sdk/advice-slip-sdk/go-cli/cmd/advice-slip@latest` |
| Go MCP server | `github.com/voxgig-sdk/advice-slip-sdk/go-mcp` | `go get github.com/voxgig-sdk/advice-slip-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Advice** | The Advice entity (load). | `/advice/{slip_id}` |
| **Search** | The Search entity (load). | `/advice/search/{query}` |
