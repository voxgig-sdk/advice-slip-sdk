...
// AdviceSlip SDK telemetry feature
...
class AdviceSlipTelemetryFeature extends AdviceSlipBaseFeature
{
    ...
    private function _close(AdviceSlipContext $ctx, bool $ok): void
    {
