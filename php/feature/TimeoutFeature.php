...
// AdviceSlip SDK timeout feature
...
class AdviceSlipTimeoutFeature extends AdviceSlipBaseFeature
{
    ...
    private function _with_timeout(AdviceSlipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AdviceSlipContext $_ctx, float $ms): void
    {
        $client = $this->client;
