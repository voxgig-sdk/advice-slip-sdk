...
// AdviceSlip SDK ratelimit feature
...
class AdviceSlipRatelimitFeature extends AdviceSlipBaseFeature
{
    ...
    private function _acquire(AdviceSlipContext $ctx): void
    {
    ...
    private function _track(AdviceSlipContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
