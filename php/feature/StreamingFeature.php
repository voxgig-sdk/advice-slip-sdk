...
// AdviceSlip SDK streaming feature
...
class AdviceSlipStreamingFeature extends AdviceSlipBaseFeature
{
    ...
    private function _iterate(AdviceSlipResult $result): \Generator
    {
    ...
    private function _streamable(AdviceSlipContext $ctx): bool
    {
