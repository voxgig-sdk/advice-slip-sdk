...
The PHP SDK for the AdviceSlip API — an entity-oriented client using PHP conventions.
...
```
php/
├── adviceslip_sdk.php          -- Main SDK class
...
The main class (`adviceslip_sdk.php`) exports the SDK class
