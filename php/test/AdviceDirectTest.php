...
class AdviceDirectTest extends TestCase
{
    public function test_direct_load_advice(): void
    {
        $setup = advice_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-advice", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
