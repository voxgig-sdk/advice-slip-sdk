...
// AdviceSlip SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AdviceSlipSDK::test)
...
{
    private const SDK_CLASS = 'AdviceSlipSDK';
    ...
    private const SDK_BASE = 'adviceslip_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../adviceslip_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
