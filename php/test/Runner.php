...
class AdviceSlipTestRunner
{
    ...
    {
        $live = self::getenv('ADVICESLIP_TEST_LIVE');
        $override = self::getenv('ADVICESLIP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ADVICESLIP_TEST_EXPLAIN');
...
class_alias('AdviceSlipTestRunner', 'Runner');
class_alias('AdviceSlipHelpers', 'Helpers');
