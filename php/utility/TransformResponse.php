...
// AdviceSlip SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AdviceSlipTransformResponse
{
    public static function call(AdviceSlipContext $ctx): mixed
    {
        ...
        $transform = AdviceSlipHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
