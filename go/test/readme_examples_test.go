...
const testSeed = `map[string]any{"entity": map[string]any{"advice": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
