...
func NewAdviceEntity(client *core.AdviceSlipSDK, entopts map[string]any) *AdviceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdviceEntity) GetName() string { return e.name }

func (e *AdviceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdviceEntity(e.client, opts)
}

func (e *AdviceEntity) Data(args ...any) any {
...
func (e *AdviceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AdviceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdviceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AdviceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdviceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdviceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdviceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
