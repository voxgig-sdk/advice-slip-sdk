...
// instead of `sdk.NewAdviceSlipSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AdviceSlipSDK  { return NewAdviceSlipSDK(nil) }
func Test() *AdviceSlipSDK { return TestSDK(nil, nil) }
