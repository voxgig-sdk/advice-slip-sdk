...
require_relative 'AdviceSlip_types'
...
class AdviceSlipSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = AdviceSlipHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = AdviceSlipHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, AdviceSlipFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    AdviceSlipUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = AdviceSlipHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = AdviceSlipHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = AdviceSlipHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = AdviceSlipHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
