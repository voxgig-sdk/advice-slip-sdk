...
module AdviceSlipTestRunner
  ...
  def self.env_override(m)
    live = getenv("ADVICESLIP_TEST_LIVE")
    override = getenv("ADVICESLIP_TEST_OVERRIDE")
    ...
    explain = getenv("ADVICESLIP_TEST_EXPLAIN")
    m["ADVICESLIP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AdviceSlipTestRunner
Helpers = AdviceSlipHelpers
Vs = VoxgigStruct
