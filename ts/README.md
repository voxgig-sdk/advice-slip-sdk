# AdviceSlip TypeScript SDK



The TypeScript SDK for the AdviceSlip API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Advice()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `AdviceSlipSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `AdviceSlipSDK.test(testopts?, sdkopts?)` | `AdviceSlipSDK` | Create a test-mode client. |
...
| `client` | `client(): AdviceSlipSDK` | Return the parent SDK client. |
...
advice-slip/
├── src/
│   ├── AdviceSlipSDK.ts        # Main SDK class
