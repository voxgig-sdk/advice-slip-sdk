# AdviceSlip TypeScript SDK Reference

Complete API reference for the AdviceSlip TypeScript SDK.
...
```ts
new AdviceSlipSDK(options?: object)
```
...
#### `AdviceSlipSDK.test(testopts?, sdkopts?)`
...
**Returns:** `AdviceSlipSDK` instance in test mode.
...
Return the parent `AdviceSlipSDK` instance.
