-- AdviceSlip SDK Advice entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AdviceEntity = {}
AdviceEntity.__index = AdviceEntity


function AdviceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdviceEntity)
  self._name = "advice"
  self._client = client
...
function AdviceEntity:get_name()
  return self._name
end


function AdviceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdviceEntity.new(self._client, opts)
end


function AdviceEntity:data_set(args)
  if args ~= nil then
...
function AdviceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdviceEntity:match_set(args)
  if args ~= nil then
...
function AdviceEntity:match_get()
...
function AdviceEntity:stream(action, args, callopts)
...
function AdviceEntity:_run_op(ctx, post_done)
  local utility = self._utility
