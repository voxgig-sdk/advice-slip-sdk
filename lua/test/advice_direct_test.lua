...
describe("AdviceDirect", function()
  it("should direct-load-advice", function()
    local setup = advice_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-advice", setup.live and "live" or "unit")
...
function advice_direct_setup(mockres)
